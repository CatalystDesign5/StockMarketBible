...
//             return res.redirect("https://catalystdesign5.github.io/StockMarketBible/succes.html?status=success");
//         } else if (paymentData.status === 'failure') {
//             console.log("Payment failed:", paymentData);
//             // Optional: Log or handle failure case as needed
//             return res.redirect("https://catalystdesign5.github.io/StockMarketBible/failure.html?status=failure");
//         }
